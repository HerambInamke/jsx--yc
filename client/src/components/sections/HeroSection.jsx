...
export default function HeroSection() {
  return (
    <section className="relative w-full h-screen bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-festival-primary-light/20 to-white/5" />
      ...
      >
        {Array.from({ length: 5 }).map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-64 h-64 rounded-full border border-festival-primary/20"
            style={{
      ...
      <div className="container mx-auto h-full flex flex-col items-center justify-center relative z-10">
        ...
        >
          <h1 className="text-8xl font-light tracking-tight mb-6">
            MUSIC FESTIVAL
            <span className="block text-6xl mt-4 text-festival-primary">2024</span>
          </h1>
        ...
        >
          <div className="relative w-[400px] h-[400px] rounded-full overflow-hidden">
            <img
              src="https://media.gq.com/photos/5f3aa9738f9d96b932abcdc3/master/pass/travis-scott-gq-cover-september-2020-a.jpg"
              alt="Featured Artist"
      ...
      >
        {socialIcons.map((icon) => (
          <a
            key={icon.name}
            href={`#${icon.name}`}
            className="text-festival-text-gray hover:text-festival-primary transition-colors"
      ...
      >
        <div className="flex flex-col items-center">
          <span className="text-sm text-festival-text-gray mb-2">Scroll</span>
          <motion.div
            animate={{
              y: [0, 10, 0],
            }}
            ...
            className="w-1 h-10 rounded-full bg-gradient-to-b from-festival-primary to-transparent"
          />
        </div>
      </motion.div>
    </section>
